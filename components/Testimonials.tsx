...
export default function Testimonials() {
  const testimonials = [
    ...
    {
      quote: "L'accompagnement en intelligence émotionnelle avec Diana a été révélateur. Grâce aux frameworks EQ 2.0 & EQ 360, j'ai développé une meilleure compréhension de mes émotions et amélioré significativement mes relations professionnelles.",
      author: "Sophie & Marc",
