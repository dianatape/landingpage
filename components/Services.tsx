...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: 'Accompagnement spécialisé basé sur les frameworks EQ 2.0 & EQ 360 pour développer votre intelligence émotionnelle, améliorer vos relations et optimiser votre potentiel personnel et professionnel.',
      icon: Heart,
      features: [
        'Certification EQ 2.0 et pratique EQ 360',
